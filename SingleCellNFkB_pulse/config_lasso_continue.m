function [cfg] = config_lasso_continue(jobname,mu,b,trajectory_index)
...
cfg.save_progress_interval = 10000;     % How often to save progress 
cfg.adapt_last = 10000;                 % last adaption step
cfg.energy_init_max = 1e8;             % maximinm allowed energy for initialization
cfg.beta_init = 0.6;                 % beta initialization parameter
cfg.relstep_init = 0.05;               % relstep initialization parameter
cfg.max_init_steps =5e10;
