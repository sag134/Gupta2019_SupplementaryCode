...
**   nfkb_lasso_cvode.c
**	 
**   Cvode-Mex implementation of BioNetGen model 'nfkb_lasso'.
**
...
**          -lsundials_nvecserial -lsundials_cvode -lm nfkb_lasso_cvode.c
**
...
**        = nfkb_lasso_cvode( timepoints, species_init, parameters )
**
**   timepoints      : column vector of time points returned by integrator.
**   parameters      : row vector of 27 parameters.
...
/* Problem Dimensions */
#define __N_PARAMETERS__   27
#define __N_EXPRESSIONS__  52
#define __N_OBSERVABLES__  12
#define __N_RATELAWS__     23
#define __N_SPECIES__      12
...
calc_expressions ( N_Vector expressions, double * parameters )
{
    ...
    NV_Ith_S(expressions,26) = pow(10.0,NV_Ith_S(expressions,0));
    NV_Ith_S(expressions,27) = pow(10.0,NV_Ith_S(expressions,1));
    NV_Ith_S(expressions,28) = pow(10.0,NV_Ith_S(expressions,2));
    NV_Ith_S(expressions,29) = parameters[26];
    NV_Ith_S(expressions,30) = pow(10.0,(NV_Ith_S(expressions,3)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,31) = pow(10.0,(NV_Ith_S(expressions,4)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,32) = pow(10.0,(NV_Ith_S(expressions,5)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,33) = pow(10.0,(NV_Ith_S(expressions,6)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,34) = pow(10.0,(NV_Ith_S(expressions,7)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,35) = pow(10.0,(NV_Ith_S(expressions,8)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,36) = (3.3*pow(10.0,(NV_Ith_S(expressions,7)+NV_Ith_S(expressions,25))));
    NV_Ith_S(expressions,37) = pow(10.0,(NV_Ith_S(expressions,8)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,38) = pow(10.0,(NV_Ith_S(expressions,16)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,39) = pow(10.0,(NV_Ith_S(expressions,17)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,40) = pow(10.0,(NV_Ith_S(expressions,14)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,41) = pow(10.0,(NV_Ith_S(expressions,15)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,42) = pow(10.0,(NV_Ith_S(expressions,9)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,43) = pow(10.0,(NV_Ith_S(expressions,10)+NV_Ith_S(expressions,24)));
    NV_Ith_S(expressions,44) = pow(10.0,(NV_Ith_S(expressions,11)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,45) = pow(10.0,(NV_Ith_S(expressions,12)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,46) = pow(10.0,(NV_Ith_S(expressions,18)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,47) = pow(10.0,(NV_Ith_S(expressions,13)+NV_Ith_S(expressions,25)));
    NV_Ith_S(expressions,48) = pow(10.0,(NV_Ith_S(expressions,20)+NV_Ith_S(expressions,23)));
    NV_Ith_S(expressions,49) = pow(10.0,(NV_Ith_S(expressions,21)+NV_Ith_S(expressions,23)));
    NV_Ith_S(expressions,50) = pow(10.0,(NV_Ith_S(expressions,22)+NV_Ith_S(expressions,23)));
    NV_Ith_S(expressions,51) = pow(10.0,(NV_Ith_S(expressions,23)+NV_Ith_S(expressions,19)));
...
calc_observables ( N_Vector observables, N_Vector species, N_Vector expressions )
{
    ...
    NV_Ith_S(observables,7) = NV_Ith_S(species,7);
    NV_Ith_S(observables,8) = NV_Ith_S(species,8);
...
{  
    NV_Ith_S(ratelaws,0) = NV_Ith_S(expressions,29)*NV_Ith_S(species,11);
    NV_Ith_S(ratelaws,1) = NV_Ith_S(expressions,30)*NV_Ith_S(species,9)*NV_Ith_S(species,11);
    NV_Ith_S(ratelaws,2) = NV_Ith_S(expressions,31)*NV_Ith_S(species,8);
    NV_Ith_S(ratelaws,3) = NV_Ith_S(expressions,32)*NV_Ith_S(species,6)*NV_Ith_S(species,8);
    NV_Ith_S(ratelaws,4) = NV_Ith_S(expressions,33)*NV_Ith_S(species,7);
    NV_Ith_S(ratelaws,5) = NV_Ith_S(expressions,34)*NV_Ith_S(species,2)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,6) = NV_Ith_S(expressions,35)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,7) = NV_Ith_S(expressions,36)*NV_Ith_S(species,0)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,8) = NV_Ith_S(expressions,37)*NV_Ith_S(species,5);
    NV_Ith_S(ratelaws,9) = NV_Ith_S(expressions,38)*NV_Ith_S(species,7)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,10) = NV_Ith_S(expressions,39)*NV_Ith_S(species,7)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,11) = NV_Ith_S(expressions,40)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,12) = NV_Ith_S(expressions,41)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,13) = NV_Ith_S(expressions,42)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,14) = NV_Ith_S(expressions,43)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,15) = NV_Ith_S(expressions,44)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,16) = NV_Ith_S(expressions,45)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,17) = NV_Ith_S(expressions,46)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,18) = NV_Ith_S(expressions,47)*NV_Ith_S(species,5);
    NV_Ith_S(ratelaws,19) = NV_Ith_S(expressions,48)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,20) = NV_Ith_S(expressions,49)*NV_Ith_S(species,10)*NV_Ith_S(species,7);
    NV_Ith_S(ratelaws,21) = NV_Ith_S(expressions,50)*NV_Ith_S(species,10)*NV_Ith_S(species,8);
    NV_Ith_S(ratelaws,22) = NV_Ith_S(expressions,51)*NV_Ith_S(species,10);
...
calc_species_deriv ( realtype time, N_Vector species, N_Vector Dspecies, void * f_data )
{
    ...
    NV_Ith_S(Dspecies,0) = -NV_Ith_S(ratelaws,7) +NV_Ith_S(ratelaws,8) +NV_Ith_S(ratelaws,13) -NV_Ith_S(ratelaws,14);
    NV_Ith_S(Dspecies,1) = -NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,6) +NV_Ith_S(ratelaws,10) +NV_Ith_S(ratelaws,12) -NV_Ith_S(ratelaws,13) +NV_Ith_S(ratelaws,14);
    NV_Ith_S(Dspecies,2) = -NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,6) -NV_Ith_S(ratelaws,9) -NV_Ith_S(ratelaws,11) -NV_Ith_S(ratelaws,15) +NV_Ith_S(ratelaws,16) +NV_Ith_S(ratelaws,17);
    NV_Ith_S(Dspecies,3) = NV_Ith_S(ratelaws,5) -NV_Ith_S(ratelaws,6) -NV_Ith_S(ratelaws,10) -NV_Ith_S(ratelaws,12) +NV_Ith_S(ratelaws,18);
    NV_Ith_S(Dspecies,4) = -NV_Ith_S(ratelaws,7) +NV_Ith_S(ratelaws,8) +NV_Ith_S(ratelaws,15) -NV_Ith_S(ratelaws,16);
    NV_Ith_S(Dspecies,5) = NV_Ith_S(ratelaws,7) -NV_Ith_S(ratelaws,8) -NV_Ith_S(ratelaws,18);
    NV_Ith_S(Dspecies,6) = -NV_Ith_S(ratelaws,3) +NV_Ith_S(ratelaws,4) +NV_Ith_S(ratelaws,20);
    NV_Ith_S(Dspecies,7) = NV_Ith_S(ratelaws,3) -NV_Ith_S(ratelaws,4) -NV_Ith_S(ratelaws,20);
    NV_Ith_S(Dspecies,8) = NV_Ith_S(ratelaws,1) -NV_Ith_S(ratelaws,2) -NV_Ith_S(ratelaws,21);
    NV_Ith_S(Dspecies,9) = -NV_Ith_S(ratelaws,1) +NV_Ith_S(ratelaws,2) +NV_Ith_S(ratelaws,21);
    NV_Ith_S(Dspecies,10) = NV_Ith_S(ratelaws,19) -NV_Ith_S(ratelaws,22);
    NV_Ith_S(Dspecies,11) = -NV_Ith_S(ratelaws,0);
...
void mexFunction( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
    ...
    {  mexErrMsgTxt("SPECIES_INIT must be a row vector with 12 elements.");  } 

    /* make sure params has correct dimensions */
    if ( (mxGetM(prhs[2]) != 1)  ||  (mxGetN(prhs[2]) != __N_PARAMETERS__) )
    {  mexErrMsgTxt("PARAMS must be a column vector with 27 elements.");  }
