function [cfg] = config_wo_lasso(nchains,jobname)
...
UB = 3;
cfg.param_defs = { ...
  struct('name','k1','prior','uniform','min',LB,'max',UB),...
  struct('name','k2','prior','uniform','min',LB,'max',UB),...
  struct('name','k3','prior','uniform','min',LB,'max',UB),...
  struct('name','k4','prior','uniform','min',LB,'max',UB),...
  struct('name','k5','prior','uniform','min',LB,'max',UB),...
  struct('name','k6','prior','uniform','min',LB,'max',UB),...
  struct('name','k7','prior','uniform','min',LB,'max',UB),...
  struct('name','k8','prior','uniform','min',LB,'max',UB),...
  struct('name','k9','prior','uniform','min',LB,'max',UB),...
  struct('name','k10','prior','uniform','min',LB,'max',UB),...
  struct('name','k11','prior','uniform','min',LB,'max',UB),...
  struct('name','k12','prior','uniform','min',LB,'max',UB),...
  struct('name','k13','prior','uniform','min',LB,'max',UB),...
  struct('name','k14','prior','uniform','min',LB,'max',UB),...
  struct('name','k15','prior','uniform','min',LB,'max',UB),...
  struct('name','k16','prior','uniform','min',LB,'max',UB),...
  struct('name','k17','prior','uniform','min',LB,'max',UB),...
  struct('name','k18','prior','uniform','min',LB,'max',UB),...
  struct('name','k19','prior','uniform','min',LB,'max',UB),...
  struct('name','k20','prior','uniform','min',LB,'max',UB),...
};
