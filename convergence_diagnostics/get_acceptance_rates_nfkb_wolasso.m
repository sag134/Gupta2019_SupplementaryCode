%Code for Table S6, S7 NFkB without lasso
...
for trajectory_number = [2,3,4]
    ...
    for start = 1:2
        ...
        %save(['nfkb_WOlasso_trajectory_',num2str(trajectory_number),'_group_',num2str(start),'_step_acceptance'],'mean_step_acceptance');
    end
end
