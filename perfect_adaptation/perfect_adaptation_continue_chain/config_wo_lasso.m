...
UB = 6;
cfg.param_defs = { ...
  struct('name','k_S_RS','prior','uniform','min',LB,'max',UB),...
  struct('name','k_XR_X','prior','uniform','min',LB,'max',UB),...
  struct('name','k_S_XS','prior','uniform','min',LB,'max',UB),...
  struct('name','k_X_0','prior','uniform','min',LB,'max',UB),...
  struct('name','k_R_0','prior','uniform','min',LB,'max',UB),...
  struct('name','k_0_R','prior','uniform','min',LB,'max',UB),...
...
cfg.energy_init_max = 50;% 0.05;             % maximum allowed energy for initialization
...
for d = 1 : cfg.nexpt
    ...
    cfg.data{d}.protocol_fcn = @(t,init,params) simulate_perfect_adaptation(t,init,params);
end
