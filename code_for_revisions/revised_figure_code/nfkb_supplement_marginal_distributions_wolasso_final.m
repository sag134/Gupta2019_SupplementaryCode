...
for trajectory_number = 2%:4 % showing results for a representative trajectory
    ...
    for repeat = 1:num_repeats
        ...
        data = load(['/shared3/LabUserFiles/Sanjana_Gupta/shared_2/LassoManuscript/SingleCellNFkB_pulse/SingleCellNFkB_continue_chain_wolasso_fixedstart_trajectory_',num2str(trajectory_number),'_repeat_',num2str(repeat_index(repeat)),'_progress990000.mat']);    
        ...
        if min(e)<emin %& repeat==1
            ...
            save(['wolassobest_params_lasso_',num2str(trajectory_number)],'repeat','ind','emin','par_min');
        end     
    ...
    %save(['../RevisedFiguresMATLAB/wolasso_Dec8_Lasso_NFkB_supplement_posterior_distribution',num2str(trajectory_number),'.mat'],'f2')
    %toPDF(f2,['../RevisedFiguresMATLAB/wolasso_Dec8_Lasso_NFkB_supplement_posterior_distribution',num2str(trajectory_number),'.pdf'])
end
%%
