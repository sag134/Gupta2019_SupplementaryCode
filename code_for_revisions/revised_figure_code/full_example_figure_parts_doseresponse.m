...
true_params = { [-1,-10,0,-10,-10,-10 ] ,...
                [-1,-10,-10,-10,-10,-10,0,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10,-10],...
                [1,-10,-10,-10,-2,-10,-10],...
                [1,1,0,0,-10,-10,-10],...
                };
fontsize = 18;
...
load([pth,'/linear_full_trajectory/linear_full_trajectory_withlasso_mu_-10_b_0.5_repeat_1_progress900000.mat'])
%%
param_indices = 1:6;
cfg.adapt_last = 5e5;
LB = 5e5;
...
n = 1000;
t = linspace(0,800,n)';
for d = 1:4 % d is the signal strength
    for j =  LB:100:cfg.nswaps
...
%savefig([save_pth,'Figure_lineardr_lasso_fit'],'png','-c0','-crop')
%%
%%
load([pth,'/linear_full_trajectory/linear_full_trajectory_wo_lasso_repeat_1_progress900000.mat'])
param_indices = 1:6;
cfg.adapt_last = 5e5;
LB = 5e5;
frills = 1;
...
set(gca,'YTickLabels',[],'XTickLabels',[]);
set(gca,'YTickLabels',[],'XTickLabels',[]);
savefig([save_pth,'Figure_lineardr_wolasso_fit'],'png','-c0','-crop')
%%
