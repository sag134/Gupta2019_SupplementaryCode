...
**   five_node_cvode.c
**	 
**   Cvode-Mex implementation of BioNetGen model 'five_node'.
**
...
**          -lsundials_nvecserial -lsundials_cvode -lm five_node_cvode.c
**
...
**        = five_node_cvode( timepoints, species_init, parameters )
**
**   timepoints      : column vector of time points returned by integrator.
**   parameters      : row vector of 20 parameters.
...
/* Problem Dimensions */
#define __N_PARAMETERS__   20
#define __N_EXPRESSIONS__  40
#define __N_OBSERVABLES__  1
#define __N_RATELAWS__     20
...
calc_expressions ( N_Vector expressions, double * parameters )
{
    ...
    NV_Ith_S(expressions,20) = pow(10.0,NV_Ith_S(expressions,0));
    NV_Ith_S(expressions,21) = pow(10.0,NV_Ith_S(expressions,1));
    NV_Ith_S(expressions,22) = pow(10.0,NV_Ith_S(expressions,2));
    NV_Ith_S(expressions,23) = pow(10.0,NV_Ith_S(expressions,3));
    NV_Ith_S(expressions,24) = pow(10.0,NV_Ith_S(expressions,4));
    NV_Ith_S(expressions,25) = pow(10.0,NV_Ith_S(expressions,5));
    NV_Ith_S(expressions,26) = pow(10.0,NV_Ith_S(expressions,6));
    NV_Ith_S(expressions,27) = pow(10.0,NV_Ith_S(expressions,7));
    NV_Ith_S(expressions,28) = pow(10.0,NV_Ith_S(expressions,8));
    NV_Ith_S(expressions,29) = pow(10.0,NV_Ith_S(expressions,9));
    NV_Ith_S(expressions,30) = pow(10.0,NV_Ith_S(expressions,10));
    NV_Ith_S(expressions,31) = pow(10.0,NV_Ith_S(expressions,11));
    NV_Ith_S(expressions,32) = pow(10.0,NV_Ith_S(expressions,12));
    NV_Ith_S(expressions,33) = pow(10.0,NV_Ith_S(expressions,13));
    NV_Ith_S(expressions,34) = pow(10.0,NV_Ith_S(expressions,14));
    NV_Ith_S(expressions,35) = pow(10.0,NV_Ith_S(expressions,15));
    NV_Ith_S(expressions,36) = pow(10.0,NV_Ith_S(expressions,16));
    NV_Ith_S(expressions,37) = pow(10.0,NV_Ith_S(expressions,17));
    NV_Ith_S(expressions,38) = pow(10.0,NV_Ith_S(expressions,18));
    NV_Ith_S(expressions,39) = pow(10.0,NV_Ith_S(expressions,19));
...
{
    NV_Ith_S(observables,0) = NV_Ith_S(species,1);
...
{  
    NV_Ith_S(ratelaws,0) = NV_Ith_S(expressions,20)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,1) = NV_Ith_S(expressions,22)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,2) = NV_Ith_S(expressions,24)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,3) = NV_Ith_S(expressions,32)*NV_Ith_S(species,0);
    NV_Ith_S(ratelaws,4) = NV_Ith_S(expressions,21)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,5) = NV_Ith_S(expressions,23)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,6) = NV_Ith_S(expressions,25)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,7) = NV_Ith_S(expressions,26)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,8) = NV_Ith_S(expressions,27)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,9) = NV_Ith_S(expressions,28)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,10) = NV_Ith_S(expressions,29)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,11) = NV_Ith_S(expressions,30)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,12) = NV_Ith_S(expressions,31)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,13) = NV_Ith_S(expressions,33)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,14) = NV_Ith_S(expressions,34)*NV_Ith_S(species,1);
    NV_Ith_S(ratelaws,15) = NV_Ith_S(expressions,35)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,16) = NV_Ith_S(expressions,36)*NV_Ith_S(species,2);
    NV_Ith_S(ratelaws,17) = NV_Ith_S(expressions,37)*NV_Ith_S(species,4);
    NV_Ith_S(ratelaws,18) = NV_Ith_S(expressions,38)*NV_Ith_S(species,3);
    NV_Ith_S(ratelaws,19) = NV_Ith_S(expressions,39)*NV_Ith_S(species,4);
...
calc_species_deriv ( realtype time, N_Vector species, N_Vector Dspecies, void * f_data )
{
    ...
    NV_Ith_S(Dspecies,0) = -NV_Ith_S(ratelaws,0) -NV_Ith_S(ratelaws,1) -NV_Ith_S(ratelaws,2) -NV_Ith_S(ratelaws,3) +NV_Ith_S(ratelaws,4) +NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,6) +NV_Ith_S(ratelaws,13);
    NV_Ith_S(Dspecies,1) = NV_Ith_S(ratelaws,0) -NV_Ith_S(ratelaws,4) -NV_Ith_S(ratelaws,7) +NV_Ith_S(ratelaws,8) -NV_Ith_S(ratelaws,9) +NV_Ith_S(ratelaws,10) -NV_Ith_S(ratelaws,14) +NV_Ith_S(ratelaws,15);
    NV_Ith_S(Dspecies,2) = NV_Ith_S(ratelaws,1) -NV_Ith_S(ratelaws,5) +NV_Ith_S(ratelaws,7) -NV_Ith_S(ratelaws,8) -NV_Ith_S(ratelaws,11) +NV_Ith_S(ratelaws,12) -NV_Ith_S(ratelaws,16) +NV_Ith_S(ratelaws,17);
    NV_Ith_S(Dspecies,3) = NV_Ith_S(ratelaws,2) -NV_Ith_S(ratelaws,6) +NV_Ith_S(ratelaws,9) -NV_Ith_S(ratelaws,10) +NV_Ith_S(ratelaws,11) -NV_Ith_S(ratelaws,12) -NV_Ith_S(ratelaws,18) +NV_Ith_S(ratelaws,19);
    NV_Ith_S(Dspecies,4) = NV_Ith_S(ratelaws,3) -NV_Ith_S(ratelaws,13) +NV_Ith_S(ratelaws,14) -NV_Ith_S(ratelaws,15) +NV_Ith_S(ratelaws,16) -NV_Ith_S(ratelaws,17) +NV_Ith_S(ratelaws,18) -NV_Ith_S(ratelaws,19);
...
void mexFunction( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
    ...
    {  mexErrMsgTxt("PARAMS must be a column vector with 20 elements.");  }
